...
use App\Http\Controllers\Frontend\OrderReportController;
...
Route::middleware(['client','status'])->group(function () {
    ...
    Route::controller(OrderReportController::class)->group(function () {
        Route::get('/reports', 'HourReport')->name('hour.report');
        Route::get('/reports/bydate', 'WeekDayReport')->name('week.day.report');
        Route::get('/reports/products', 'ProductsReport')->name('products.report');
        Route::get('/reports/season', 'ProductsSeasonReport')->name('products.season.report');
